...
namespace GuardianAngel
{
    public partial class respondindexV3 : System.Web.UI.Page
    {
        ...
        protected void dbLoad() //load資料
        {
            ...
            //    sds.ConnectionString = @"Data Source=13.76.157.247; Initial Catalog=Guardian_Angel;Persist Security Info=False;User ID=guardian-angel;Password=Team20181043;MultipleActiveResultSets=False;Encrypt=false;TrustServerCertificate=False;Connection Timeout=30";
